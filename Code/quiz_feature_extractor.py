...
# ----------------------------
# Main Embedding Pipelines
# ----------------------------

def generate_all_data_embeddings():
    # Paths
    parent_folder = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))
    data_folder = os.path.join(parent_folder, "Quizzes")
...
def save_student_embeddings_to_csv(student_embeddings, filename="quiz_embeddings.csv"):
    """
