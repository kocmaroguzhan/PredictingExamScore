...
for assesment_name in assesment_names:
    ...
    for train_idx, val_idx in kf.split(question_answer_multiply_original_X):
        print(f"\n====== Fold {fold} ======")
        X_train_original, X_val_original = question_answer_multiply_original_X[train_idx], question_answer_multiply_original_X[val_idx]
        ...
        # Apply filtering
        X_train_aug = question_answer_multiply_aug_X[train_aug_mask]
