...
for assesment_name in assesment_names:
    ...
    question_answer_diff_aug_X = substract_question_answer_embeddings(augmented_df, question_embeddings_df, assesment_name)
    ...
    for train_idx, val_idx in kf.split(question_answer_diff_original_X):
        print(f"\n====== Fold {fold} ======")
        X_train_original, X_val_original = question_answer_diff_original_X[train_idx], question_answer_diff_original_X[val_idx]
        y_train_original, y_val_original = original_y[train_idx], original_y[val_idx]
        X_train_original_noisy = generate_noisy_samples(X_train_original, embedding_dim,noise_std=0.001)
        ...
        # Apply filtering
        X_train_aug = question_answer_diff_aug_X[train_aug_mask]
        ...
        X_train_final,y_train_final=merge_samples(X_train_original_combined,X_train_aug,y_train_original_combined,y_train_aug)
