...
for assesment_name in assesment_names:
    ...
    question_answer_merge_original_X = merge_question_answer_embeddings(original_df, question_embeddings_df, assesment_name)
    question_answer_merge_aug_X = merge_question_answer_embeddings(augmented_df, question_embeddings_df, assesment_name)
...
for train_idx, val_idx in kf.split(question_answer_merge_original_X):
    print(f"\n====== RidgeCV Fold {fold} ======")

    # Split features and labels
    X_train, X_val = question_answer_merge_original_X[train_idx], question_answer_merge_original_X[val_idx]
